    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          Column(
            children: [
              customText("Email", 20, Colors.black, FontWeight.normal),
          ...
          Column(
            children: [
              customText("Password", 20, Colors.black, FontWeight.normal),
              const SizedBox(height: 10),
              TextFormField(
            ...
            children: [
                  ...
                  if (isLogged) {
                    ...
                    loggedRow = Row(
                      children: [
                        ...
                        customText("Il login è errato", 17, Colors.red,
                            FontWeight.w500)
                      ],
                    );
                    setState(() {});
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Center(
                      child: customText(
                          "Ospite", 20, Colors.black, FontWeight.normal)),
                ),
              )
            ],
          )
